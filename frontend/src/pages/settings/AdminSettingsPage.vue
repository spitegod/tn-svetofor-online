...
import AppearanceSettings from '@/features/appearance/AppearanceSettings.vue'

export type AdminSettingsPageViewModel = {
  [key: string]: any
}

const props = defineProps<{ model: AdminSettingsPageViewModel }>()
...
<template>
      <section class="settings-page">
        <header class="admin-settings-heading">
          <span class="settings-section__eyebrow">Администрирование</span>
        ...
        <AppearanceSettings
          :model-value="fontSizePreset"
          :presets="fontSizePresets"
          @update:model-value="fontSizePreset = $event"
        />
      </section>
